...
| **µU/mL**        | micro-unidades por mililitro (concentración)     |
| **min⁻¹**        | por minuto (frecuencia o tasa de cambio)         |
| **min⁻²**        | por minuto al cuadrado                           |
| **mg/dL·min⁻¹**  | entrada de glucosa por minuto                    |
| **µU/mL·min⁻¹**  | entrada de insulina por minuto                   |
| **µU·mL⁻¹·min⁻¹**| producción de insulina por concentración y tiempo|
